<div id="main">
	<div class="container">
		...
		<h3>お題設定</h3>
		<form method="post" action="create" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" id="post_form">
			<div class="form-group">
				<label for="input_title" class="col-sm-3 control-label">タイトル<span class="message_a">*</span></label>
				<div class="input-field col s9">
					<input id="last_name" type="text" class="validate" name="topic_title"
						   value="<?php if(!empty($id)){echo h($topic['title']);} ?>">
					<label for="last_name">タイトル</label>
				</div>
			</div>
			<div class="form-group">
				<label for="input_body" class="col-sm-3 control-label">本文<span class="message_a">*</span></label>
				<div class="input-field col s12">
					<textarea id="textarea1" class="materialize-textarea" name="topic_content"><?php if(!empty($id)){echo $topic['content'];} ?></textarea>
...
<!--			</div>-->
			<div class="form-group mt-10">
				<label for="input_vote_date" class="col-sm-3 control-label">投稿締め切り<span class="message_a topic_auto">*</span>
<!--						--><?php //if($topic['topic_format'] != 0){echo"style='display:none'";} ?>
					</label>
				<div class="col-sm-6">
					<input type="text" class="datepicker" id="input_vote_date" name="topic_vote_date"
						   value="<?php if(!empty($id) and $topic['topic_vote_date'] != "0000-00-00 00:00:00"){echo date("Y/m/d H:i", strtotime($topic['topic_vote_date']));} ?>" />
				</div>
				<label for="input_result_date" class="col-sm-3 control-label">採点締め切り<span class="message_a topic_auto">*</span>
<!--						--><?php //if($topic['topic_format'] != 0){echo"style='display:none'";} ?>
					</label>
				<div class="col-sm-6">
					<input type="text" class="datepicker" id="input_result_date" name="topic_result_date"
...
<!--						--><?php //if($topic['topic_type'] == line){echo "active";} ?>
">
							<input type="radio" value="line" name="topic_type"
<!--								--><?php //if($topic['topic_type'] == line){echo "checked";} ?>
							>穴埋め・ひと言</label>
					</div>
				</div>
			</div>
